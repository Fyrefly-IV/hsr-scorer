...
<template>
	<div v-if="fullMode.screen === 'start'" class="flex max-w-[800px] flex-col">
		...
		<P class="text-center">
			...
			settings. The process may take a significant amount of time, so we recommend ensuring
			that you exclude any characters from the list that you do not wish to compare.
		</P>
		...
		<P class="text-center">
			...
			cookies or are not using incognito mode in your browser, each step is saved in the
			browser itself, and you will be able to return to this page to continue the process!
		</P>
	</div>
